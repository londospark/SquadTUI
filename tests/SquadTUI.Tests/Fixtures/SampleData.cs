...
public static class SampleData
{
    ...
    public static string GetCharterFor(string memberName) => memberName switch
    {
        ...
        "Knuckles" => "# Knuckles — Backend Dev\n\nThe guardian who protects the service layer. Implements data providers, service interfaces, and all backend infrastructure.\n\nKnuckles builds the bridge between raw `.ai-team/` files and the UI layer. His services parse markdown, YAML, and structured data into clean domain models.\n\n## Goals\n- Build reliable file-based data providers\n- Implement all service interfaces\n- Ensure data integrity and error handling",
        "Amy" => "# Amy — Tester\n\nThe pink hedgehog who never misses a bug. Writes and maintains the automated test suite covering unit, integration, and E2E scenarios.\n\nAmy ensures every feature has proper test coverage. She uses Hex1b headless mode for TUI testing and maintains test fixtures for service validation.\n\n## Goals\n- Write comprehensive automated tests\n- Maintain test fixtures and infrastructure\n- Catch regressions before they ship",
